...
| `E0487`  | The time span given to `withTimeout` or `Task.delay` is neither milliseconds (an integer) nor a `Duration` | Async §18.1.9 |
...
| `W0530`  | Cyclic class initialization within a module *(retired: the check is the error `E0497`, ERRATA E89; the number is not reused)* | Semantics §S.4.2 |
