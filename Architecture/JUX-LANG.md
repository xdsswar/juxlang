...
**Version:** 0.1 (design)
**Status:** ⚠️ **SUPERSEDED by `JUX-LANG-V1.md`** — this is the original dossier, kept for history only. It is not maintained; where it disagrees with `JUX-LANG-V1.md`, the addenda, or `ERRATA.md`, those documents win. Do not edit this file.
**File extension:** `.jux`
