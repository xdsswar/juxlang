...
| `@Derive(...)`                        | **Deprecated no-op** — accepted for forward compatibility, ignored (W0240 suggests removal); operator capabilities auto-derive unconditionally | JUX-OPERATORS-ADDENDUM §O.9 / JUX-MISSING-DEFS §M.3 |
