...
$docs = @(
  ...
  @{ md='JUX-INHERITANCE-BORROW-ADDENDUM.md';  title='Inheritance × Borrow Inference';          section='Earlier' },
  @{ md='JUX-ASYNC-ADDENDUM-v2.md';            title='Async / Await (v2)';                      section='Earlier' },
  @{ md='JUX-GAPS-ROADMAP.md';                 title='Gaps Roadmap (historical)';               section='Earlier' }
)
...
function Get-SidebarHtml {
  ...
  $sections = @('Foundation', 'Core', 'Compiler', 'Earlier')
  $sectionTitles = @{
    'Foundation' = 'Foundation'
    'Core'       = 'Core Specifications'
    'Compiler'   = 'Compiler &amp; Tooling'
    'Earlier'    = 'Earlier Addenda'
  }
